...
const char *textureFiles[] = {
    ...
    "../lab2/textures/fasade_sky5.png",
    "../lab2/textures/fasade_sky6.png",
...
struct Museum {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale, const char *textureFile) {
        ...
        char *selectedTexture = "../lab2/textures/gpo56.png";
        textureID = LoadTextureTileBox(selectedTexture);
...
struct Roof {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale, const char *textureFile) {
        ...
        char *selectedTexture = "../lab2/textures/grey44.png";
        textureID = LoadTextureTileBox(selectedTexture);
...
struct Pillar {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale) {
        ...
        textureID = LoadTextureTileBox("../lab2/textures/grey44.png");
...
struct Plateau {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale) {
        ...
        textureID = LoadTextureTileBox("../lab2/textures/grass2.png");
...
struct Street {
    ...
    void initialize(glm::vec3 position, glm::vec3 scale) {
        ...
        textureID = LoadTextureTileBox("../lab2/textures/street3.png");
...
int main(void) {
    ...
    Museum museum;
    museum.initialize(glm::vec3(-270, 10, 260), glm::vec3(100, 210, 190), "../lab2/textures/gpo2.png");
    ...
    Roof roof;
    roof.initialize(glm::vec3(-150, 230, 260), glm::vec3(50, 30, 110), "../lab2/textures/roof.png");
